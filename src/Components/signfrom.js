          ...
          <form className="space-y-6">
            ...
            <label className="relative flex items-start mt-2">
              <div className="flex items-center h-5">
                <input
                  type="checkbox"
                  className={`form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out cursor-pointer ${matchCheck ? "focus:border-red-500" : "focus:border-indigo-500"
                    }`}
                />

              </div>
              <div className="ml-2 text-sm font-bold leading-5">
